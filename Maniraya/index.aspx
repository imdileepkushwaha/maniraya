<%@ Page Title="" Language="C#" MasterPageFile="~/WebMasterPage.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="index" %>
          ...
          <div class="hero-shell">
              <div class="hero-main">
                  <div id="selectedCarousel" class="selected-carousel" aria-label="Promotional carousel">
                      <div class="selected-carousel-track">
                          <article class="selected-slide slide-one is-active">
                              ...
                              <div class="selected-slide-content">
                                  ...
                                  <p class="hero-slide-desc">Discover premium electronics, fashion and daily essentials — curated for you at unbeatable prices.</p>
                          ...
                          <article class="selected-slide slide-two">
                              ...
                              <div class="selected-slide-content">
                                  ...
                                  <p class="hero-slide-desc">Trending products with secure checkout, fast delivery and hassle-free returns.</p>
                                  <div class="hero-slide-actions">
                          ...
                          <article class="selected-slide slide-three">
                              ...
                              <div class="selected-slide-content">
                                  ...
                                  <p class="hero-slide-desc">Premium quality products for modern everyday living — handpicked by Maniraya.</p>
                                  <div class="hero-slide-actions">
                      ...
                      <button class="hero-carousel-btn hero-carousel-prev" type="button" aria-label="Previous slide">
                      ...
                      <div class="selected-carousel-footer">
                          <span class="hero-slide-counter"><strong class="hero-slide-current">01</strong> / 03</span>
                          <div class="selected-carousel-dots" role="tablist" aria-label="Carousel navigation">
                              <button class="selected-dot is-active" type="button" aria-label="Go to slide 1" data-slide-to="0"></button>
                              <button class="selected-dot" type="button" aria-label="Go to slide 2" data-slide-to="1"></button>
                              <button class="selected-dot" type="button" aria-label="Go to slide 3" data-slide-to="2"></button>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <aside class="hero-side" aria-label="Featured offers">
                  <article class="hero-promo-card hero-promo-primary">
                      ...
                      <h3>Extra 20% Off</h3>
                      <p>Use code <strong>MANIRAYA20</strong> on your first order. Limited time only.</p>
...
<section class="top-categories">
   ...
   >
     <div class="category-card-media">
        <img src='<%# Eval("Image") %>'
     alt='<%# Eval("CategoryName") %>' loading="lazy" />
     ...
     <div class="container">
         ...
         <asp:DropDownList ID="ddcountry" runat="server" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="ddcountry_SelectedIndexChanged">
...
<section id="about" class="about-section">
    <div class="container">
        <div class="about-section-head">
            ...
            <p>We are redefining online shopping with curated quality, secure payments, and service you can count on every day.</p>
        </div>

        <div class="about-main">
            <div class="about-visual">
                <div class="about-visual-frame">
                    <img src="https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=900&q=80" alt="Happy customers shopping online" loading="lazy" />
            ...
            <div class="about-info">
                <div class="about-info-card">
                    <div class="about-info-top">
                        ...
                        <p class="about-info-lead">From discovery to doorstep delivery, Maniraya brings together premium products, wallet rewards, and a seamless checkout experience — all in one trusted platform.</p>
                    </div>
                    ...
                    <div class="about-features-grid">
                        <article class="about-feature-card about-feature-secure">
                            ...
                            <span class="about-feature-icon" aria-hidden="true">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 2L3 7V11C3 16.55 6.84 21.74 12 23C17.16 21.74 21 16.55 21 11V7L12 2Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/></svg>
                            </span>
                        ...
                        <article class="about-feature-card about-feature-delivery">
                            ...
                            <span class="about-feature-icon" aria-hidden="true">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M3 7H21L19 21H5L3 7ZM3 7L2 3H1" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><circle cx="9" cy="20" r="1" fill="currentColor"/><circle cx="17" cy="20" r="1" fill="currentColor"/></svg>
                            </span>
                            <div class="about-feature-body">
                                <h4>Fast Delivery</h4>
                        ...
                        <article class="about-feature-card about-feature-support">
                            ...
                            <span class="about-feature-icon" aria-hidden="true">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 8V12L15 15M21 12C21 16.97 16.97 21 12 21C7.03 21 3 16.97 3 12C3 7.03 7.03 3 12 3C16.97 3 21 7.03 21 12Z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
                            </span>
                            <div class="about-feature-body">
                                <h4>24/7 Support</h4>
                        ...
                        <article class="about-feature-card about-feature-returns">
                            ...
                            <span class="about-feature-icon" aria-hidden="true">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12M7 12V13C7 14.1 7.9 15 9 15H10L12 17L14 15H15C16.1 15 17 14.1 17 13V12" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            </span>
                            <div class="about-feature-body">
                                <h4>Easy Returns</h4>
                    ...
                    <div class="about-actions">
                        ...
                        <a href="mailto:info@mpremium.in" class="btn-hero-outline about-outline-btn">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="coupon-banner">
              <div class="coupon-banner-offer">
                  ...
                  <div class="coupon-banner-code">
                      <span>Use code</span>
                      <strong>MANIRAYA20</strong>
                  </div>
              </div>
              <div class="coupon-banner-signup">
                  <span class="section-eyebrow">Stay Updated</span>
                  <h2>Get Your Discount Coupon</h2>
                  <p>Subscribe to our newsletter and unlock member-only deals, early access sales, and special offers.</p>
                  <div class="coupon-subscribe-form" role="group" aria-label="Newsletter email signup">
                      <div class="coupon-input-wrap">
                          <svg class="coupon-input-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                              <path d="M4 6h16a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1Z" stroke="currentColor" stroke-width="1.6"/>
                              <path d="m4 7 8 6 8-6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                          </svg>
                          <input type="email" id="couponEmailInput" placeholder="Enter your email address" autocomplete="email" aria-label="Email address" />
                      </div>
  ...
  <a
      href="https://wa.me/918884448586?text=Hi%20Maniraya%2C%20I%20need%20help"
