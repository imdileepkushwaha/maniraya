...
public partial class UserRepurchaseReportDP : System.Web.UI.Page
{
    ...
    public DataTable getPurchaseProductQuantityFranchisee(clsProduct objstate, string Fromdate, String Todate)
    {
        ...
        {
            str_query += " and isnull(PU.Isdistributer,0)=1 and isnull(PU.Cstatus,0)='" + objstate.PurchaseStatus + "'";
        }
