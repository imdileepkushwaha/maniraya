...
public partial class Franchisee_FRUMDDDD : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            TxtCash.Text = Convert.ToString((Convert.ToDecimal(TxtTotalTotalDP.Text) * (Convert.ToDecimal(ViewState["profit"].ToString()))) / 100);
