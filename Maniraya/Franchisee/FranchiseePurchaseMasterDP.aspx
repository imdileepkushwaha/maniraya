<%@ Page Title="" Language="C#" MasterPageFile="franchiseemaster.master" AutoEventWireup="true" CodeFile="FranchiseePurchaseMasterDP.aspx.cs" Inherits="FranchiseePurchaseMasterDP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
      ...
      <h1>
    Franchisee Purchase FV Price
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Product management</a></li>
        <li class="active"> Franchisee Purchase FV Price </li>
      </ol>
    </section>    
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Franchisee Purchase Distributer Price</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
