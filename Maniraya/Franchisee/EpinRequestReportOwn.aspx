<%@ Page Title="Deposit Request Report" Language="C#" MasterPageFile="franchiseemaster.master" AutoEventWireup="true" CodeFile="EpinRequestReportOwn.aspx.cs" Inherits="EpinRequestReport" %>
                                  ...
                                  <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("Image") %>' Height="40px" Width="40px"  /></asp:LinkButton>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="Sponser Id">
                                    ...
                                    <asp:TemplateField HeaderText="Sponser Name">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblEpinamount" runat="server" Text='<%#Eval("Totalamount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Status">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblDepositBank" runat="server" Text='<%#Eval("paymentmode") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
