...
public partial class UserDileveryReportDP : System.Web.UI.Page
{
    ...
    public DataTable getPurchaseProductQuantityFranchisee(clsProduct objstate, string Fromdate, String Todate)
    {
        ...
        {
            str_query += " and isnull(PU.Isdistributer,0)=1 and isnull(PU.Cstatus,0)=1 and isnull(PU.Dstatus,0)='" + objstate.PurchaseStatus + "'";
        }
