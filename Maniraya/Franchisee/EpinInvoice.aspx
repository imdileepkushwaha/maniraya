<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EpinInvoice.aspx.cs" Inherits="user_EpinInvoice" %>
...
<div style="margin-top: 10px;">
    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound">
      ...
      <div style="background-color:#4800ff; color:#fff; text-align:right; padding:10px; font-size:16px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Discount ₹ <asp:Label ID="Lblcash" runat="server" Text="0"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total Payble ₹ <asp:Label ID="LblRest" runat="server" Text="Label"></asp:Label> </div>

     <div></div>

     <b>  TOTAL Amount : <asp:Label ID="lblTotalAmount" runat="server" Text="Label" ></asp:Label><asp:Label ID="lblTotaldp" runat="server" Text="Label" Visible="false"></asp:Label> ONLY || 
...
Support: Contact us at growmaniraya@gmail.com / 8884448586 for inquiries.</p>
                </ul> 
			  </td>
            </tr>
      </table> 
