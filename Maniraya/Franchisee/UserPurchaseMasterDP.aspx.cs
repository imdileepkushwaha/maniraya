...
public partial class UserPurchaseMasterDP : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["fuserid"] != null)
        {
            if (!IsPostBack)
            {
                ...
                loadProduct();
                loadDonarFranchisee();
                LblType.Text = "Distributer Price";
    ...
    void loaduser()
    {
        ...
        if (dt.Rows.Count > 0 )
        {
            if (dt.Rows[0]["isdistributer"].ToString() == "1")
            {
            ...
            else
            {
                ...
                Message.Show("User is not applicable for DP price...!!!");
            }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "del")
        {
            ...
            if (!string.IsNullOrEmpty(e.CommandArgument.ToString()))
            {
                ...
                {
                    j += Convert.ToDecimal(dr["TOTALDP"]);
                }
    ...
    {
        string str_query = "SELECT ProductID,isnull(Sum(CrQuantity),0) as Cr,isnull(Sum(DrQuantity),0) as Dr FROM FranchiseeStockMaster where ProductId='" + ID + "' and Franchiseeid='" + franchiseeId + "' and isnull(IsDistributer,0)=1 GROUP BY ProductID ";
        DataTable dt = null;
        ObjData.StartConnection();
        try
        {
        ...
        try
        {
            ...
            if (ChkStock == "1")
            {
                ...
                SqlParameter[] parameter = {
                   ...
                   new SqlParameter("@IsDistributer","1")
