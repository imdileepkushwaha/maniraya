<%@ Page Title="" Language="C#" MasterPageFile="franchiseemaster.master" AutoEventWireup="true" CodeFile="FranchiseePurchaseDetailFV.aspx.cs" Inherits="FranchiseePurchaseDetailFV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
      ...
      <h1>
     Franchisee Distributer Purchase Detail
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Purchase management</a></li>
        <li class="active"> Franchisee Distributer Purchase Detail </li>
      </ol>
    </section>    
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Franchisee Distributer Purchase Detail</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                    ...
                    <asp:GridView ID="gvOrders" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-hover dataTable" >
                        <Columns>
                            ...
                            <asp:BoundField ItemStyle-Width="150px" DataField="ProductName" HeaderText="Product Name" />
                              <asp:BoundField ItemStyle-Width="150px" DataField="SubProductName" HeaderText="SubProduct Name" />
                              <asp:BoundField ItemStyle-Width="150px" DataField="MRP" HeaderText="MRP" />
                               <asp:BoundField ItemStyle-Width="150px" DataField="Quantity" HeaderText="Quantity" />                               
                                <asp:BoundField ItemStyle-Width="150px" DataField="TotalBV" HeaderText="TotalBV" />
                            <asp:BoundField ItemStyle-Width="150px" DataField="TotalSV" HeaderText="TotalSV" />
                                   ...
                                   <asp:TemplateField HeaderText="Total Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lbluserid2" runat="server" Text='<%#Eval("TotalAmount") %>' Visible="false"></asp:Label>
                                               <asp:Label ID="lbluserdp" runat="server" Text='<%#Eval("TotalDP") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Payment" Visible="false">
                                        <ItemTemplate>
                                           Discount <asp:Label ID="lblCash" runat="server" Text='<%#Eval("Cash") %>'></asp:Label><br />
                                              Total SV <asp:Label ID="lbltotalSV" runat="server" Text='<%#Eval("totalsv") %>'></asp:Label><br />
                                 ...
                                 <%--  <asp:TemplateField HeaderText="Payble Amount">
                                    ...
                                    <asp:TemplateField HeaderText="Invoice" Visible="false">
                                        <ItemTemplate>
                                            ...
                                            <asp:HyperLink ID="HyperLink1" runat="server" Text="Invoice" class="btn btn-outline-dark btn-text w-100" NavigateUrl='<%# string.Format("FranchiseeInvoiceDP.aspx?OrderNo={0}",
