<%@ Page Title="" Language="C#" MasterPageFile="franchiseemaster.master" AutoEventWireup="true" CodeFile="FranchiseeJoiningStockDetail.aspx.cs" Inherits="FranchiseeJoiningStockDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
      ...
      <h1>
    Franchisee Joining Stock Detail
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Product management</a></li>
        <li class="active"> Franchisee Joining Stock Detail </li>
      </ol>
    </section>    
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Franchisee Joining Stock Detail</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                               ...
                               <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="Product Name">
                                     ...
                                     <asp:TemplateField HeaderText="Sale">
                                      ...
                                      <asp:TemplateField HeaderText="Stock Left" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lbluseridContactNo" runat="server" Text='<%#Eval("StockLeft") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Stock Hold" >
                                        <ItemTemplate>
                                            <asp:Label ID="lbluseridhold" runat="server" Text='<%#Eval("HOLDSTOCK") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Stock balance" >
                                        <ItemTemplate>
                                            <asp:Label ID="lbluseribalance" runat="server" Text='<%#Eval("balance") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
