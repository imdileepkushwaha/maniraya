...
<%@ Page Title="Deposit Request" Language="C#" MasterPageFile="franchiseemaster.master" AutoEventWireup="true" CodeFile="EpinRequestAdd.aspx.cs" Inherits="EpinRequestAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
    ...
    E-Pin Request  
     ...
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <li class="active"> E-Pin Request Add </li>
      </ol>
    </section>    
                    ...
                    <div class="row" style="display:none">
					   ...
					   <div class="row" style="display:none">
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-6">
                             <div class="form-group">
                                 <span><label> Plan Amount :</label>&nbsp;<asp:Label ID="Label1" Visible="false" runat="server" style="font-weight:bold;color:red"></asp:Label></span>
                                   <asp:TextBox ID="Txtplanamount" readonly="true"   runat="server" onkeypress="return isNumberKey(event);" CssClass="form-control" />
                             </div>
                         </div>
                           ...
                           <div class="row">
                             ...
                             <div class="form-group">
                                ...
                                <asp:TextBox ID="txtnoofepin" TextMode="Number" AutoPostBack="true" OnTextChanged="txtnoofepin_TextChanged" CssClass="form-control" runat="server"></asp:TextBox>
                             </div>
                         </div>
                        <div class="col-md-6">
                             <div class="form-group">
                                 <span><label> Amount :</label></span>
                                   <asp:TextBox ID="TxtEpinamount" readonly="true"   runat="server" onkeypress="return isNumberKey(event);" CssClass="form-control" />
                             </div>
                         </div>
                     </div>
                   <div class="row">
                         <div class="col-md-6">
                             <div class="form-group">
                                 <span><label> Discount :</label></span>
                                   <asp:TextBox ID="TxtDiscount" readonly="true"   runat="server" onkeypress="return isNumberKey(event);" CssClass="form-control" />
                             </div>
                         </div>
                         <div class="col-md-6">
                             <div class="form-group">
                                 <span><label> Payble Amount :</label>&nbsp;<asp:Label ID="lblmssg" Visible="false" runat="server" style="font-weight:bold;color:red"></asp:Label></span>
