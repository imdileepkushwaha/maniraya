<%@ Page Title="" Language="C#" MasterPageFile="franchiseemaster.master" AutoEventWireup="true" CodeFile="UserPurchaseDetailDP.aspx.cs" Inherits="UserPurchaseDetailDP" %>
                                   ...
                                   <asp:TemplateField HeaderText="Total DP">
                                     ...
                                     <asp:TemplateField HeaderText="Purchase date">
                                       ...
                                       <asp:TemplateField HeaderText="Invoice">
                                        <ItemTemplate>
                                             <asp:HyperLink runat="server" Target="_blank" NavigateUrl='<%# string.Format("JoiningInvoiceDP.aspx?OrderNo={0}",
