...
public partial class UserPurchaseDetailDP : System.Web.UI.Page
{
    ...
    public DataTable getuserFranchiseePurchase(clsvendor objstate)
    {
        ...
        str_query += " and isnull(P.isdistributer,0)=1 order BY P.PurchaseId desc";
        DataTable dt = null;
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            dt1 = getUserFranchiseePurchaseProductChild(customerId);
