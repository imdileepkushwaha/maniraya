<%@ Page Title="" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="RepurchaseLevelIncome.aspx.cs" Inherits="user_RepurchaseLevelIncome" %>
                                    ...
                                    <asp:TemplateField HeaderText="From Date">
                                     ...
                                     <asp:TemplateField HeaderText="User Id">
                                      ...
                                      <asp:TemplateField HeaderText="From User Id">
                                        <ItemTemplate>
                                            <asp:Label ID="lblrremark" runat="server" Text='<%#Eval("fromuserid") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
