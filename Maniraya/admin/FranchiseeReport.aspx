...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
      <script type="text/javascript">
          ...
          function validate3() {
              if (document.getElementById("<%=txtSponsorId.ClientID%>").value == "") {

                  alert('Enter Sponserid');
                  document.getElementById("<%=txtSponsorId.ClientID%>").focus();
                  return false;
              }
              if (document.getElementById("<%=txtSponsorName.ClientID%>").value == "") {
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentpageData" runat="Server">
                        ...
                        <div class="box-body">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                     ...
                                     <asp:TemplateField HeaderText="Sponser Action">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbSEdit" CommandName="sedt" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" runat="server"><i class="icon fa fa-pencil-square-o" aria-hidden="true"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
  ...
  <asp:TextBox ID="ddareaedit"  CssClass="form-control" runat="server" Visible="false"></asp:TextBox>
              ...
              <div id="DivSponser" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Sponser Details</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                             <div class="col-md-4">
                         ...
                         <asp:TextBox ID="TxtFranchiseeid" CssClass="form-control" runat="server" Enabled="false"></asp:TextBox>
                                        </div>
                             ...
                             <div class="col-md-4">
                                    ...
                                    <asp:TextBox ID="TxtFranchiseename" Enabled="false" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                        ...
                        <div class="row">
                         ...
                         <asp:TextBox ID="txtSponsorId" CssClass="form-control" runat="server" AutoPostBack="True" OnTextChanged="txtSponsorId_TextChanged"></asp:TextBox>
                             ...
                             <div class="col-md-4">
                                    ...
                                    <asp:TextBox ID="TxtType" Enabled="false" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                         ...
                         <div class="modal-footer">
                            <asp:Button ID="Btnsponserupdate" runat="server" Text="Update" OnClientClick="return validate3();" CssClass="btn btn-primary" OnClick="Btnsponserupdate_Click"/>
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                        </div>
                        </div>
                    </div>
        ...
        function LoadHandler() {
         ...
         <script type="text/javascript">
             ...
             function showModalsponser() {
                 $('#DivSponser').modal({ backdrop: 'static', keyboard: false })
             }
             function Closepopupsponser() {
                 $('#DivSponser').modal('hide');
                 $('body').removeClass('modal-open');
                 $('body').css('padding-right', '0');
                 $('.modal-backdrop').remove();
             }
