<%@ Page Title="" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="FranchiseePurchaseMasterDP.aspx.cs" Inherits="FranchiseePurchaseMasterDP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
      ...
      <h1>
    Franchisee Purchase Distributer Price
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Product management</a></li>
        <li class="active"> Franchisee Purchase Distributer Price </li>
      </ol>
    </section>    
</asp:Content>
