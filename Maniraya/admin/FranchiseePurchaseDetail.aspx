...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
      ...
      <h1>
     Franchisee Customer Purchase Detail
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Franchisee management</a></li>
        <li class="active"> Franchisee Customer Purchase Detail </li>
      </ol>
    </section>    
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Franchisee Customer Purchase Detail</h3>
              ...
              <div class="box-body">
                         ...
                         <div class="col-md-12">
                             <div class="form-group table-responsive">
                                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound" DataKeyNames="PurchaseID">
                                ...
                                <asp:BoundField ItemStyle-Width="150px" DataField="TotalAmount" HeaderText="TotalAmount" />
                                   ...
                                   <asp:TemplateField HeaderText="Total">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lbluserid3" runat="server" Text='<%#Eval("TotalDP") %>' Visible="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
