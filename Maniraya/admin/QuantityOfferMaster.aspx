<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminmaster.master" AutoEventWireup="true" CodeFile="QuantityOfferMaster.aspx.cs" Inherits="admin_QuantityOfferMaster" %>
     ...
     <script type="text/javascript">
         ...
         function validate() {
             ...
             if (document.getElementById("<%=DDLstProduct.ClientID%>").value == "0") {
               ...
               if (document.getElementById("<%=TxtQuatity.ClientID%>").value == "") {

                 alert('Enter Quantity');
                 // alert("Enter Rank No"); 
                 document.getElementById("<%=TxtQuatity.ClientID%>").focus();
                   return false;
               }
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
      ...
      <h1>
       Offer Quantity Master   
      </h1>
      <ol class="breadcrumb">
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Utility management</a></li>
        <li class="active">Offer Quantity Master   </li>
      </ol>
    </section>   
</asp:Content>
                 ...
                 <div class="box-body">
                     <div class="row">
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label>Quatity</label>
                                    <asp:TextBox ID="TxtQuatity" CssClass="form-control" runat="server" TextMode="Number"></asp:TextBox>
                             </div>
                         </div>
                     </div>
                     <div class="row">
