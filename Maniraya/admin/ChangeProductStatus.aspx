          ...
          <div class="col-md-12">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDataBound="GridView1_RowDataBound" >
              ...
              <div class="box-footer admin-product-footer">
                  <asp:Button ID="btnUpdate" CssClass="btn btn-primary" runat="server" Text="Update Status" OnClick="btnUpdate_Click" />
              </div>
