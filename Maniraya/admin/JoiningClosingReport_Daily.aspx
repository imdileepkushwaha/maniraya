<%@ Page Title="" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="JoiningClosingReport_Daily.aspx.cs" Inherits="JoiningClosingReportDaily" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
  <section class="content-header">
     ...
     <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
        ...
        <li class="active">   Daily Payout</li>
      </ol>
    </section>  
</asp:Content>
                            ...
                            <div class="row">
                                ...
                                <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Matching Income">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalleft" runat="server" Text='<%#Eval("BinaryIncome") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
