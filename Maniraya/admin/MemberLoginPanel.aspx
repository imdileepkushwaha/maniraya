                            ...
                            <div class="row">
                                <div class="col-md-6">
                                   ...
                                   <div class="col-md-6">
                                    <div class="form-group">
                                        <label>USer Name</label>
                                      <asp:TextBox runat="server" CssClass="form-control form_date" ID="txtusername"></asp:TextBox>
                                    </div>
                                </div>
                               ...
                               <div class="col-md-6">
                                 ...
                                 <label>Status</label>
                                          <asp:DropDownList ID="ddlststatus" CssClass="form-control" runat="server">
                                            <asp:ListItem Value="-1"> Select Staus</asp:ListItem>
...
<div class="row">
                ...
                <div class="form-group">
                  <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" AllowPaging="True" PageSize="50" OnPageIndexChanging="GridView1_PageIndexChanging"  >
                                <Columns>
                           ...
                           <asp:TemplateField HeaderText="User Name">
                               ...
                               <ItemTemplate>
                                     <asp:Label ID="LblUserImage" runat="server"  Text='<%#Eval("UserImage") %>'></asp:Label>
                               </ItemTemplate>
                           </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>

                                          <%--    <a href='../User/Dashboard.aspx?imid=<%#Eval("UserId") %>' class="btn" style="color:lightgreen">ViewStatement</a>--%>

                                            <asp:LinkButton ID="lbEdit" CommandName="edt"  CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"  runat="server" ><b>UserLoginPanel</b></i></asp:LinkButton>
                                        </ItemTemplate>                                       
                                    </asp:TemplateField>
                            </Columns>
                            </asp:GridView>
