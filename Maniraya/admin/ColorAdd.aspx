<%@ Page Title="" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="ColorAdd.aspx.cs" Inherits="ColorAdd" %>
...
<asp:TextBox runat="server" class="form-control" ID="Txtcolorcodeedit" ></asp:TextBox>
    </div>
                            <div class="form-group">
                            Status
