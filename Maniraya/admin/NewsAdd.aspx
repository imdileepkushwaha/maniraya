                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Edit">
                                     ...
                                     <asp:TemplateField HeaderText="Delete">
                                        <ItemTemplate>
                                              <asp:LinkButton ID="lbDelete" CssClass="admin-grid-delete-btn" CommandName="mydel" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" runat="server"><i class="icon fa fa-remove" aria-hidden="true"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
