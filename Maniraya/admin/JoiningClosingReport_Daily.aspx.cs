...
public partial class JoiningClosingReportDaily : System.Web.UI.Page
{
    ...
    void loaddata()
    {
        ...
        DataTable Dt = null;// objCL.getJoiningClosingReportdaily(Fromdate, Todatedate, TxtUserId.Text);
