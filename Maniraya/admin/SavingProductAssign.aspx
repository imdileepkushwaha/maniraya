                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Assign  Saving Product </h3>
                        </div>
                        ...
                        <div class="box-body admin-product-form">
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <label>Prev Assigned Product</label>
                                            <div class="admin-input-group">
                                                <span class="admin-input-icon"><i class="fa fa-shopping-basket"></i></span>
                                               <asp:TextBox ID="txtproductname" Enabled="false" CssClass="form-control" runat="server" placeholder="Prev Assigned Product" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="box-footer admin-product-footer">
                            ...
                            <asp:Button ID="btnSubmit" CssClass="btn btn-primary" OnClientClick="return validate();" runat="server" Text="Assign Product" OnClick="btnSubmit_Click1" />
                        </div>
                    </div>
                </div>
            </div>
