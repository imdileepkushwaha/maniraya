...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"> Saving  Product management</a></li>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="admin-input-group">
                                                ...
                                                <asp:TextBox ID="txtmrp" CssClass="form-control" runat="server" placeholder="Enter product name" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="admin-input-group">
                                                <span class="admin-input-icon"><i class="fa fa-rupee"></i></span>
                                                <asp:TextBox ID="txtdp" CssClass="form-control" runat="server" placeholder="Enter product name" />
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="admin-input-group">
                                                <span class="admin-input-icon"><i class="fa fa-rupee"></i></span>
                                                <asp:TextBox ID="txtgst" CssClass="form-control" runat="server" placeholder="Enter GST" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="admin-input-group">
                                                <span class="admin-input-icon"><i class="fa fa-rupee"></i></span>
                                                <asp:TextBox ID="txthsncode" CssClass="form-control" runat="server" placeholder="Enter HSN Code" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="admin-input-group">
                                                <span class="admin-input-icon"><i class="fa fa-image"></i></span>
