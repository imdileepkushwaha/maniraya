                        ...
                        <div class="modal-content">
                         ...
                         <asp:Label ID="lblstateid" Visible="false" runat="server" Text=""></asp:Label>
                          ...
                          <asp:TextBox runat="server" class="form-control" ID="TxtAmountEdit" TextMode="Number"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    DP                      
                          <asp:TextBox runat="server" class="form-control" ID="TXTDP" TextMode="Number"></asp:TextBox>
                                </div>
                                  <div class="form-group">
                                   Buisness Volume                     
                          ...
                          <asp:TextBox runat="server" class="form-control" ID="TxtMrp" TextMode="Number"></asp:TextBox>
                                 ...
                                 <div class="form-group">
                                    HSNCODE                      
                          <asp:TextBox runat="server" class="form-control" ID="TxtHsncode" TextMode="Number"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    BatchNo                      
                          <asp:TextBox runat="server" class="form-control" ID="Txtbatchno" TextMode="Number"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    GST                      
                          <asp:TextBox runat="server" class="form-control" ID="txtGst" TextMode="Number"></asp:TextBox>
                                </div>
                                <div class="form-group">
