<%@ Page Title="Saving Level Income Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="SavingLevelIncomeReport.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        <h1>Saving Level Income Report</h1>
        <ol class="breadcrumb">
            <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Accounts</a></li>
            <li class="active">Saving Level Income Report</li>
        </ol>
    </section>
</asp:Content>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body admin-search-form">
                                <p class="admin-report-intro">View saving level income (level 2 and above) by date range or user ID.</p>
                            ...
                            <div class="box-body">
                                <div class="admin-table-wrap table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%"
                                        AutoGenerateColumns="False" EmptyDataText="No saving level income records found." OnRowCommand="GridView1_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Transaction ID">
                                                <ItemTemplate><asp:Label ID="lblusername" runat="server" Text='<%# Eval("transactionid") %>' /></ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Level No">
                                                <ItemTemplate><asp:Label ID="lblemail" runat="server" Text='<%# Eval("levelno") %>' /></ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Amount">
                                                <ItemTemplate><asp:Label ID="lblmobile" runat="server" Text='<%# Eval("amount") %>' /></ItemTemplate>
                                            </asp:TemplateField>
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentScript" runat="Server">
    ...
    <script type="text/javascript">
        function bindSavingLevelIncomeDatePickers() {
        ...
        Sys.Application.add_load(bindSavingLevelIncomeDatePickers);
    </script>
</asp:Content>
