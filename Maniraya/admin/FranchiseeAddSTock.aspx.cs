...
public partial class FranchiseeAddSTock : System.Web.UI.Page
{
	...
	private void getFundwallet()
    {
        ...
        objaccount.UserId = TxtFranchiseeId.Text;// Session["fuserId"].ToString();
    ...
    void loadSubProduct()
    {
        ...
        DataTable dt = new DataTable();
            ...
            dt = objP.getSubProductForPurchase(DDLstProduct.SelectedValue);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //}
            ...
            DR["Image"] = ((Label)Gr.FindControl("LblProductImageG")).Text;
                ...
                if (((Label)Gr.FindControl("LblSubProductCodeG")).Text == DDLstSubProduct.SelectedValue)
                {
    ...
    private void ClearValue()
    {
        ...
        DDLstSubProduct.SelectedIndex = 0;
        TxtImage.Text = "";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "edt")
        {
            ...
            TxtSubProductCode.Text = ((Label)GridView1.Rows[index].FindControl("LblSubProductCodeG")).Text;
            TxtProductName.Text = ((Label)GridView1.Rows[index].FindControl("LblProductNameG")).Text;
            TxtSubProductName.Text = ((Label)GridView1.Rows[index].FindControl("LblSubProductNameG")).Text;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow Gr in GridView1.Rows)
        {
            if (((Label)Gr.FindControl("LblSubProductCodeG")).Text == TxtSubProductCode.Text)
            {
                DR = PurchaseDt.NewRow();               
                DR["ProductId"] = ((Label)Gr.FindControl("LblProductCodeG")).Text;
                DR["SubProductId"] = ((Label)Gr.FindControl("LblSubProductCodeG")).Text;
	 ...
	 public DataTable getProductForPurchaseselectNew(string ID)
    {
        ...
        string str_query = "SELECT ProductId,Productname,CASE WHEN productimage='' THEN '../img/images.png' ELSE  '../img/'+ productimage END AS [Image],MRP,Amount,bv,GST,DP,SV FROM ProductMaster   where 1=1 and ProductId='" + ID + "' ";
    ...
    protected void BtnSubmitPurchase_Click(object sender, EventArgs e)
    {
        ...
        //  objbank.fr
        objbank.UserId = TxtFranchiseeId.Text;// Session["fuserid"].ToString();
