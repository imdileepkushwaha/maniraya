<%@ Page Title="Saving Direct Income Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="SavingDirectIncomeReport.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        <h1>Saving Direct Income Report</h1>
        <ol class="breadcrumb">
            <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Accounts</a></li>
            <li class="active">Saving Direct Income Report</li>
        </ol>
    </section>
</asp:Content>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body admin-search-form">
                                <p class="admin-report-intro">View saving direct income (level 1) by date range or user ID.</p>
                            ...
                            <div class="box-body">
                                <div class="admin-table-wrap table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%"
                                        AutoGenerateColumns="False" EmptyDataText="No saving direct income records found." OnRowCommand="GridView1_RowCommand">
                                        <Columns>
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentScript" runat="Server">
    ...
    <script type="text/javascript">
        function bindSavingDirectIncomeDatePickers() {
        ...
        Sys.Application.add_load(bindSavingDirectIncomeDatePickers);
    </script>
</asp:Content>
