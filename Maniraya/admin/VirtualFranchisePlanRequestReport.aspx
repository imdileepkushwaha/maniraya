<%@ Page Title="Virtual Franchise Plan Requests" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="VirtualFranchisePlanRequestReport.aspx.cs" Inherits="admin_VirtualFranchisePlanRequestReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        <h1>Virtual Franchise Plan Requests</h1>
        <ol class="breadcrumb">
            ...
            <div class="admin-report-page">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body admin-search-form">
                                <p class="admin-report-intro">Approve or reject pending virtual franchise plan requests. On approve, 40-month ROI is generated and Level 1 income is credited after 10% admin + 2% TDS. Rejection reason is shown to the user.</p>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-list-alt"></i> Plan Requests</h3>
                            </div>
                            <div class="box-body">
                                ...
                                <div class="admin-table-wrap table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable" Width="100%"
                                        AutoGenerateColumns="False" EmptyDataText="No virtual franchise plan requests found."
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Amount">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblamount" runat="server" CssClass="admin-amount-text" Text='<%# Eval("planamount") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Request Date">
                                                <ItemTemplate><%# Eval("entrydate", "{0:dd/MM/yyyy hh:mm tt}") %></ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Pay Slip">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkph" runat="server" CssClass="admin-product-thumb-link" CommandName="photolarge" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>">
                                                        <img src='../ProductImage/<%# string.IsNullOrEmpty(Convert.ToString(Eval("imagename"))) ? "noimage.png" : Eval("imagename") %>' class="admin-product-thumb" alt="Payment screenshot" />
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentScript" runat="Server">
    ...
    <script type="text/javascript">
        function initVfAdminDatepickers() {
        ...
        $(function () { initVfAdminDatepickers(); });
        Sys.Application.add_load(function () { initVfAdminDatepickers(); });
    </script>
</asp:Content>
