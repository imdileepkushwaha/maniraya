...
<asp:Content ID="Content3" ContentPlaceHolderID="contentpageData" Runat="Server">
    ...
    <div class="profile-page dash-subpage dash-subpage--saving">
        <div class="profile-hero dash-subpage-hero dash-subpage-hero--saving">
            <div class="profile-hero-avatar" aria-hidden="true"><i class="fa fa-university"></i></div>
                ...
                <div class="dash-subpage-panel-body">
                    <div class="dash-care-showcase">
                        ...
                        <div class="dash-care-showcase-footer">
                            ...
                            <span class="dash-care-showcase-chip" aria-hidden="true"><i class="fa fa-university"></i></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="dash-subpage-panel">
                    ...
                    <div class="dash-subpage-panel-body">
                        <div class="dash-metric-grid dash-metric-grid--3">
                            ...
                            <div class="dash-metric-card">
                                <span class="dash-metric-card-icon tone-amber" aria-hidden="true"><i class="fa fa-clock"></i></span>
                                <div class="dash-metric-card-content">
                ...
                <div class="dash-subpage-panel">
                    ...
                    <div class="dash-subpage-panel-body">
                        <div class="dash-metric-grid dash-metric-grid--3">
                            ...
                            <div class="dash-metric-card">
                                <span class="dash-metric-card-icon tone-emerald" aria-hidden="true"><i class="fa fa-rupee-sign"></i></span>
                                <div class="dash-metric-card-content">
                                    <p class="dash-metric-card-label">Maturity Amount</p>
                                    <p class="dash-metric-card-value"><i class="fa fa-rupee-sign"></i> <asp:Label ID="lblmaturityamount" runat="server" Text="0.00" /></p>
                                </div>
                            </div>
                            <div class="dash-metric-card">
                                <span class="dash-metric-card-icon tone-gold" aria-hidden="true"><i class="fa fa-calendar-check"></i></span>
                                <div class="dash-metric-card-content">
                        ...
                        <div class="dash-income-status-row">
                            <div class="dash-highlight-card dash-highlight-card--compact">
                                <div class="dash-highlight-card-main">
                                    <span class="dash-highlight-card-icon" aria-hidden="true"><i class="fa fa-chart-line"></i></span>
                                    <div class="dash-highlight-card-text">
                                        <h4>Level Income</h4>
                                        <p>Your total level-wise earnings</p>
                                    </div>
                                    <div class="dash-highlight-card-amount"><i class="fa fa-rupee-sign"></i> <asp:Label ID="lbllevelincome" runat="server" Text="0" /></div>
                                </div>
