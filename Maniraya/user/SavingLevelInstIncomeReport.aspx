<%@ Page Title="Saving Level Installment Income" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SavingLevelInstIncomeReport.aspx.cs" Inherits="user_SavingLevelInstIncomeReport" %>
        ...
        <ContentTemplate>
            <div class="profile-page team-page transaction-report-page">
                <div class="profile-hero">
                    <div class="profile-hero-avatar" aria-hidden="true"><i class="fa fa-sync-alt"></i></div>
                    <div class="profile-hero-info">
                        <h2>Saving Level Installment Income</h2>
                        <p class="profile-hero-meta">Your installment income where Inst No &gt; 1 (first installment excluded).</p>
                    </div>
                    ...
                    <div class="box-header with-border box-header-enhanced box-header-tone-1">
                        <div class="box-header-main">
                            ...
                            <div class="box-header-text">
                                ...
                                <p class="box-subtitle">Filter your installment income by date and inst no</p>
                            </div>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="row team-filter-grid transaction-filter-grid">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    <label for="<%= txtInstNo.ClientID %>"><i class="fa fa-hashtag"></i> Inst No</label>
                                    <asp:TextBox ID="txtInstNo" CssClass="form-control" runat="server" placeholder="e.g. 2"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box box-primary">
                    <div class="box-header with-border box-header-enhanced box-header-tone-6">
                        <div class="box-header-main">
                            ...
                            <div class="box-header-text">
                                <h3 class="box-title">Income Details (Inst No &gt; 1)</h3>
                                <p class="box-subtitle">Installment-based saving level income for your account</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group team-table-group">
                            <div class="team-table-wrap table-responsive">
                                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable team-table" Width="100%"
                                    AutoGenerateColumns="False" EmptyDataText="No installment income records found (Inst No &gt; 1)."
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentScript" runat="Server">
    ...
    <script type="text/javascript">
        function initSavingLevelInstIncomeDatepickers() {
        ...
        $(function () { initSavingLevelInstIncomeDatepickers(); });
        Sys.Application.add_load(initSavingLevelInstIncomeDatepickers);
    </script>
</asp:Content>
