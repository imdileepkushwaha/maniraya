...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" runat="Server">
    <section class="content-header">
        <h1 style="color:white">Address Proof/Aadhar</h1>
        <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="box-footer" id="div_noupdate" runat="server" visible="false"><span style="float:right;font-size:20px;color:red;"><i>You cannot upload  Address details.Please contact admin.</i></span></div>
                        </div>
                                    </div>
                                </div>
                            </div>
