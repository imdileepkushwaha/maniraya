...
public partial class user_SavingDirectIncomeReport : System.Web.UI.Page
{
...
WHERE sd.LevelNo = 1
  AND sd.UserId = '" + SqlEscape(userId) + "'";
    ...
    protected void imgExcel_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=SavingDirectIncomeReport.xls");
        Response.Charset = "";
