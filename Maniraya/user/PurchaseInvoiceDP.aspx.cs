...
public partial class PurchaseInvoiceDP : System.Web.UI.Page
{
    ...
    {
        string str_query = "SELECT PU.TotalDP,PU.Cstatus Pstatus,PU.purchaseamount,PU.CGST+PU.SGST+PU.IGST GST,PU.orderNo,PU.PurchaseId,PU.TotalAmount,PU.Userid  AS UserId,Convert(CHAR,PU.PurchaseDate,103) AS PurchaseDate,U.Username ,U.Email Emailid,U.Mobile AS ContactNo,(Select top 1 isnull(invoicestatus,0) from PurchaseProductMaster where purchaseId=PU.purchaseId) as InvoiceStatus  FROM   UserFranchiseePurchaseMaster PU JOIN Userdetail U ON PU.UserId=U.userid  where 1=1 ";
     ...
     //   if (objstate.PurchaseStatus != string.Empty)
      ...
      //  }
        ...
        str_query += " and isnull(PU.isdistributer,0)=1 order by PU.id desc";
        DataTable dt = null;
