...
public partial class JoiningInvoiceDP : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            LblPaybleamount.Text = Convert.ToString(Convert.ToDecimal(LblPaybleamount.Text) + Convert.ToDecimal(LblShipping.Text));
