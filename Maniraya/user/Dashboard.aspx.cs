...
ORDER BY x.CouponCode ASC";
    ...
    void LoadIncentiveAmounts(string userId, int days)
    {
        ...
        lblRenewalDirectIncome.Text = "0.00";
        lblRenewalsLevelIncome.Text = "0.00";
        lblDirectorIncomeCard.Text = "0.00";
        lblFastTrackIncome.Text = "0.00";
        lblSuperFastTrackIncome.Text = "0.00";
        lblRepurchaseIncomeCard.Text = "0.00";
        lblVirtualFranchiseBonus.Text = "0.00";
