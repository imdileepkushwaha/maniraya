...
<%@ Page Title="Deposit Request" Language="C#" MasterPageFile="Masterpage.master" AutoEventWireup="true" CodeFile="EpinRequestAddNew.aspx.cs" Inherits="EpinRequestAddNew" %>
        ...
        <ContentTemplate>
          ...
          <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Epin Request</h3>
            </div>
                   <div class="box-body">
                       <%--<h4> Request Type</h4>
                        <hr />--%>
                    ...
                    <div class="row" style="display:none">
					   ...
					   <div class="row" style="display:none">
                        ...
                        <div class="col-md-6">
                             <div class="form-group">
                                 <span><label> Amount :</label>&nbsp;<asp:Label ID="lblmssg" Visible="false" runat="server" style="font-weight:bold;color:red"></asp:Label></span>
