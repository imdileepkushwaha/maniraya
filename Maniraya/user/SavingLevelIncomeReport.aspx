<%@ Page Title="Saving Level Income Report" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SavingLevelIncomeReport.aspx.cs" Inherits="user_SavingLevelIncomeReport" %>
            ...
            <div class="profile-page team-page transaction-report-page">
                <div class="profile-hero">
                    ...
                    <div class="profile-hero-info">
                        <h2>Saving Level Income Report</h2>
                        <p class="profile-hero-meta">Your saving level income for level 2 and above.</p>
                    </div>
                    ...
                    <div class="box-header with-border box-header-enhanced box-header-tone-6">
                        <div class="box-header-main">
                            ...
                            <div class="box-header-text">
                                ...
                                <p class="box-subtitle">Level 2+ saving income for your account</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group team-table-group">
                            <div class="team-table-wrap table-responsive">
                                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable team-table" Width="100%"
                                    AutoGenerateColumns="False" EmptyDataText="No saving level income records found."
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentScript" runat="Server">
    ...
    <script type="text/javascript">
        function initSavingLevelIncomeDatepickers() {
        ...
        $(function () { initSavingLevelIncomeDatepickers(); });
        Sys.Application.add_load(initSavingLevelIncomeDatepickers);
    </script>
</asp:Content>
