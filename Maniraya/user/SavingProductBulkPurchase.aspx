<%@ Page Title="Bulk Purchase" Language="C#" MasterPageFile="masterpage.master" AutoEventWireup="true" CodeFile="SavingProductBulkPurchase.aspx.cs" Inherits="user_SavingProductBulkPurchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPageHeading" Runat="Server">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Bulk Purchase</li>
        </ol>
    </section>
</asp:Content>
            ...
            <div class="profile-page saving-purchase-page topup-request-page">
                <div class="profile-hero">
                    ...
                    <div class="profile-hero-info">
                        <h2>Bulk Purchase</h2>
                        <p class="profile-hero-meta">Pay 18 months together (₹18,000). New or existing savers can buy. Each package gets its own coupon; old package stays separate.</p>
                    </div>
                    ...
                    <div class="box-header with-border box-header-enhanced box-header-tone-4">
                        <div class="box-header-main">
                            ...
                            <div class="box-header-text">
                                <h3 class="box-title">18 Month Bulk Purchase</h3>
                                <p class="box-subtitle">One payment for 18 months. Products ship month by month from your join date.</p>
                            </div>
                        </div>
                    </div>

                    <div class="box-body profile-form-grid">
                        <asp:Panel ID="pnlProductShowcase" runat="server" Visible="false">
                            <asp:Image ID="imgProduct" runat="server" />
                            <asp:Literal ID="litProductName" runat="server" />
                            <asp:Literal ID="litDp" runat="server" />
                        ...
                        <div class="saving-purchase-summary">
                            ...
                            <div class="form-group">
                                <label for="<%= txtamount.ClientID %>"><i class="fa fa-rupee-sign"></i> 18 Month Amount</label>
                        ...
                        <div class="saving-purchase-info-note">
                            ...
                            <span>Pay the 18-month amount, enter UTR and upload screenshot. Admin will approve. Remaining installments show as Paid. Income for months 2–18 is released at month-end. Prize, bonus and dispatch stay installment-wise — no extra treat.</span>
                        </div>
                    </div>
