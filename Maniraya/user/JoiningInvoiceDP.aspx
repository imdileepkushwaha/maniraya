<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JoiningInvoiceDP.aspx.cs" Inherits="JoiningInvoiceDP" %>
...
<div style="margin-top: 10px;">
    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound">
               ...
               <asp:TemplateField HeaderText="IGST">
                                        ...
                                        <ItemTemplate>
                                              <asp:Label ID="lblTotalDP" runat="server" Text='<%#Eval("TotalDP") %>' ></asp:Label>
                                                          <asp:Label ID="LblTotalAmt" runat="server" Text='<%#Eval("TotalAmount") %>' Visible="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   </Columns>
    </asp:GridView>
     ...
     <b>  TOTAL DP : <asp:Label ID="lblTotalAmount" runat="server" Text="Label" Visible="false" ></asp:Label><asp:Label ID="lblTotaldp" runat="server" Text="Label" ></asp:Label> ONLY || 
