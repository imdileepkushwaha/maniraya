...
public partial class user_UserJoiningInvoice : System.Web.UI.Page
{
    ...
    {
        string str_query = "SELECT PU.cashamount,PU.restamount,PU.TotalDP,PU.Cstatus Pstatus,PU.purchaseamount,PU.CGST+PU.SGST+PU.IGST GST,PU.orderNo,PU.PurchaseId,PU.TotalAmount,PU.Userid  AS UserId,Convert(CHAR,PU.PurchaseDate,103) AS PurchaseDate,U.Username ,U.Email Emailid,U.Mobile AS ContactNo,(Select top 1 isnull(invoicestatus,0) from PurchaseProductMaster where purchaseId=PU.purchaseId) as InvoiceStatus  FROM   UserjoiningPurchaseMaster PU JOIN Userdetail U ON PU.UserId=U.userid  where 1=1 ";
        ...
        str_query += " and isnull(PU.isdistributer,0)=0 order by PU.id desc";
        DataTable dt = null;
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            HyperLink btnSuccess = (HyperLink)e.Row.FindControl("HyperLink1");
