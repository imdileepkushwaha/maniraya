...
public partial class PurchaseItemRepurchaseDP : System.Web.UI.Page
{
    ...
    void loadProduct(int PageIndex)
    {
        ...
        dt = ProductPageWiseFranchisee(PageIndex, PageSize, HdFranchiseeid.Value, HDPlantype.Value, HDPlanId.Value, "1");
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "photolarge")
        {
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                LblDP.Text = Dt.Rows[0]["DP"].ToString();
        ...
        if (e.CommandName == "BuyProduct")
        {
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                TxtTotalDP.Text = Dt.Rows[0]["DP"].ToString();
