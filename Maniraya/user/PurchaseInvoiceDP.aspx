<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="PurchaseInvoiceDP.aspx.cs" Inherits="PurchaseInvoiceDP" %>
 ...
 <asp:Label ID="lblpurchaseamount" runat="server" Text='<%#Eval("purchaseamount") %>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Total DP">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblemail" runat="server" Text='<%#Eval("TotalDP") %>'></asp:Label>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HyperLink ID="HyperLink1" runat="server" Text="Invoice" class="btn btn-outline-dark btn-text w-100" NavigateUrl='<%# string.Format("JoiningInvoiceDP.aspx?OrderNo={0}",
