...
public partial class user_SavingLevelInstIncomeReport : System.Web.UI.Page
{
...
WHERE ISNULL(sd.InstNo, 0) > 1
  AND sd.UserId = '" + SqlEscape(userId) + "'";
        ...
        {
            sql += " AND sd.InstNo = " + instNo;
        }

        sql += " ORDER BY sd.mentiondate DESC, sd.InstNo ASC";
    ...
    protected void imgExcel_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=SavingLevelInstIncomeReport.xls");
        Response.Charset = "";
