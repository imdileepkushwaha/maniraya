                ...
                <article class="reg-confirm-card">
                    ...
                    <div class="reg-confirm-content">
                        <div class="reg-confirm-brand">
                            <img src="<%= ResolveUrl("~/myassets/assets/images/logo.png") %>" alt="<%= clsUtility.ProjectName %>" class="reg-confirm-logo" />
                        </div>
                        ...
                        <div class="reg-confirm-buttons">
                            <a href="<%= ResolveUrl("~/Login.aspx") %>" class="reg-confirm-btn reg-confirm-btn-primary">Login Now</a>
                            <a href="<%= ResolveUrl("~/index.aspx") %>" class="reg-confirm-btn reg-confirm-btn-secondary">Back to Home</a>
                        </div>
                    </div>
