<%@ Page Title="Saving Direct Income Report" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SavingDirectIncomeReport.aspx.cs" Inherits="user_SavingDirectIncomeReport" %>
        ...
        <ContentTemplate>
            <div class="profile-page team-page transaction-report-page">
                <div class="profile-hero">
                    <div class="profile-hero-avatar" aria-hidden="true"><i class="fa fa-user-plus"></i></div>
                    <div class="profile-hero-info">
                        <h2>Saving Direct Income Report</h2>
                        <p class="profile-hero-meta">Your saving direct income (level 1).</p>
                    </div>
                    ...
                    <div class="box-header with-border box-header-enhanced box-header-tone-6">
                        <div class="box-header-main">
                            ...
                            <div class="box-header-text">
                                ...
                                <p class="box-subtitle">Level 1 saving direct income for your account</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group team-table-group">
                            <div class="team-table-wrap table-responsive">
                                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover dataTable team-table" Width="100%"
                                    AutoGenerateColumns="False" EmptyDataText="No saving direct income records found."
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentScript" runat="Server">
    ...
    <script type="text/javascript">
        function initSavingDirectIncomeDatepickers() {
        ...
        $(function () { initSavingDirectIncomeDatepickers(); });
        Sys.Application.add_load(initSavingDirectIncomeDatepickers);
    </script>
</asp:Content>
