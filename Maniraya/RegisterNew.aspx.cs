...
public partial class RegisterNew : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        */
        ...
        objUser.UserId = TxtUsrid.Text;
        string res = Insert_Userdemo(objUser);
        if (res == "f")
        {
            string popupScript = "alert('Aadhar No Already Exists');";
            ...
            {
                string popupScript = "alert('this userid already exists');";
                ScriptManager.RegisterStartupScript(UpdatePanel1, UpdatePanel1.GetType(), Guid.NewGuid().ToString(), popupScript, true);
            }
            else if (res == "ext")
            {
    ...
    public string Insert_Userdemo(clsUser objUser)
    {
        string res = "";
        string s2 = "";
        SqlConnection cn;
